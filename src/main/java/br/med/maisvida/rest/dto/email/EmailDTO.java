package br.med.maisvida.rest.dto.email;
...
public class EmailDTO implements Serializable {
	...
	public String toString() {
		...
		final int maxLen = 10;
		return "EmailDTO [" + ( from != null ? "from=" + from + ", " : "" ) + ( to != null ? "to=" + toString(to, maxLen) + ", " : "" ) + ( cc != null ? "cc=" + toString(cc, maxLen) + ", " : "" ) + ( bcc != null ? "bcc=" + toString(bcc, maxLen) + ", " : "" ) + ( subject != null ? "subject=" + subject + ", " : "" )+ ( content != null ? "content=" + content + ", " : "" ) + ( variables != null ? "variables=" + toString(variables.entrySet(), maxLen) : "" ) + "]";
	}
